# SITE: Personal Archive of Bunnykey

## Core Identity
Personal Archive of Bunnykey
...
- [x] history.md (Timeline)

### Phase 2: Blog Engine
- [x] blog.html (List & Filtering)
- [x] post.html (Template)
- [x] Author Management (JSON/Metadata)
- [x] CRUD Definition & Search Implementation
